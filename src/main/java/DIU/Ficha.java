...
public class Ficha extends javax.swing.JFrame {
    ...
    public Ficha() {
        ...
        lblCeduladp.setText(FichaVehicula.txtCedula.getText());
        lblNombresdp.setText(FichaVehicula.txtNombres.getText());
        lblPlacadp.setText(FichaVehicula.txtPlaca.getText());
