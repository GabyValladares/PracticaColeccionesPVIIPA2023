...
import DIU.EjercicioFichaVehicular.ReporteValorPagar;
import DIU.EjercicioFichaVehicular.TablaVehiculo;
import DIU.Menu;
...
//       ficha.setVisible(true);
    ...
    private void txtCedulaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtCedulaMouseClicked
      PersonaController instancia = new PersonaController();
      int cedula = Integer.parseInt(txtCedula.getText());
      String nombresCompletos = instancia.obtenerNombresCompletosCedula(cedula);
      txtNombres.setText(nombresCompletos);
    }//GEN-LAST:event_txtCedulaMouseClicked

    private void btnVerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVerMouseClicked
    PersonaController instancia2 = new PersonaController();
