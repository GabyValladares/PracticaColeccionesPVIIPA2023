...
public class Ficha extends javax.swing.JFrame {
    ...
    public Ficha() {
        ...
        lblCeduladp.setText(FichaVehicular.txtCedula.getText());
        lblPlacadp.setText(FichaVehicular.txtPlaca.getText());
        lblNombresdp.setText(FichaVehicular.txtNombres.getText()); 
        //lblTipodp.setText(FichaVehicular.TOOL_TIP_TEXT_KEY);
        //lblMultasdp.setText(FichaVehicular.IS_SELECTED_PROPERTY);
        //lblMarcadp.setText(FichaVehicular.IS_SELECTED_PROPERTY);
