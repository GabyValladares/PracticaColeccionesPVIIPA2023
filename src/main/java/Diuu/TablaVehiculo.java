...
public class TablaVehiculo extends javax.swing.JInternalFrame {
    ...
    ArrayList<VehiculoV> listaVehiculosLD=new ArrayList<>();
    ...
    public void llenarArray(){
        VehiculoV vehiculo=new VehiculoV(placa, marca, color, tipo, multas,añoFabricacion , Double.parseDouble(valor));
        PersonaV persona=new PersonaV(nombre,Integer.parseInt( cedula), listaVehiculosLD);
    ...
    public void setDatos(){
        ...
        int cont=1;
        for(VehiculoV puntero:listaVehiculosLD){
        filas[0]=cont;
