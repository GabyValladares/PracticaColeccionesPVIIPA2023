...
--
-- Host: localhost    Database: bddvisual
-- ------------------------------------------------------
...
INSERT INTO `persona` VALUES (1,'Dylan','Guamialama',1004828354,'guami','Guami100'),(2,'Carlos','Gordillo',1003497102,'Carlitos','Gordito'),(3,'Marlon','Tituaña',100282913,'Chikito','conciencia'),(4,'Alen','Pineda',1004289121,'Ale','Pineda'),(5,'Alexis','afasfasñd',1839129,'valsdj','qweql');
...
--
-- Dumping events for database 'bddvisual'
--

--
-- Dumping routines for database 'bddvisual'
--
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_CrearVehiculo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_CrearVehiculo`(
IN placa varchar(6), IN color varchar(45), IN marca varchar(45), IN tipo varchar(45), 
IN valor int, IN idpersona int
)
BEGIN
INSERT INTO vehiculos (placa,color,marca,tipo,valor,idpersona) 
values (placa,color,marca,tipo,valor,idpersona);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `verPersonas` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `verPersonas`()
begin
select * from persona;
END ;;
DELIMITER ;
...
-- Dump completed on 2024-02-14 18:03:46
