 ...
 * @author tutut
 */
public class PilasTorresHanoi extends javax.swing.JInternalFrame {

    private Stack<String> torre1, torre2, torre3;
    private DefaultTableModel modelTorre1, modelTorre2, modelTorre3;
    private int contP;
    public PilasTorresHanoi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        LbPasos.setText("Vas en el Paso: 0");
    ...
    if (contP == 0) {
        ...
        LbPasos.setText("Vas en el Paso: " +contP);
    } else if (contP == 1) {
    ...
    private void moverDisco(Stack<String> origen, Stack<String> destino) {
        if (!origen.isEmpty()) {
    ...
    private void actualizarTabla(DefaultTableModel model, Stack<String> torre) {
        model.setRowCount(0);
