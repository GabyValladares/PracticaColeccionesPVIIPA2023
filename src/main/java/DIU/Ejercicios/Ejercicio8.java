...
public class Ejercicio8 extends javax.swing.JInternalFrame {
    ...
    private final Queue<Integer> consultasQueue = new LinkedList<>();
    private final Queue<Integer> cancelacionesQueue = new LinkedList<>();
    private final Queue<Integer> solicitudesQueue = new LinkedList<>();
    private final ArrayList usuAtend = new ArrayList();
