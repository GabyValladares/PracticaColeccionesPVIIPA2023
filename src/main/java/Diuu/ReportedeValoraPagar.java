...
public class ReportedeValoraPagar extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setFont(new java.awt.Font("Berlin Sans FB", 1, 24)); // NOI18N
        lblTitulo.setText("Valor a Pagar:");
    ...
    private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameActivated
        ...
        if (cedulaEmpiezaEn1 && placaContieneLetraI) {
            ...
            validarDatos = "A cobrar un 5% del sueldo básico ( +" + Renovacion + ") por la renovación de placas.";
        } else {
            validarDatos = "No se aplican cargos";
        }
      ...
      if (marca != null && tipo != null) { 
        ...
        if(multas.equals("Si")){
            ...
            multasR = "Tiene multas. Su valor a pagar es: "+valorPagar;
            
        }else if(multas.equals("No")){
            multasR = "No tiene multas. Su valor a pagar es: 0.00 ";
        }
