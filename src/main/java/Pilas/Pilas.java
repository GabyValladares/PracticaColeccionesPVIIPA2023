...
public class Pilas extends javax.swing.JFrame {
    ...
    // Obtener la cadena ingresada y dividirla en palabras
    String cadena = Txtpalabra.getText();
    String[] palabras = cadena.split("\\s+");

    // Validar que haya al menos dos palabras
    if (palabras.length < 2) {
        // Mostrar un mensaje de error si no hay suficientes palabras
        JOptionPane.showMessageDialog(this, "Debe ingresar al menos dos palabras separadas por espacios.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    // Añadir las palabras a la pila en el orden especificado
    for (int i = 0; i < tamaño; i++) {
        int indice = i % 2;  // Alterna entre 0 y 1
        pila.push("Posición " + i + ": " + palabras[indice]);
    }

    // Mostrar la lista en el txtArea
    mostrarListaEnTxtArea(pila);
}

// Método para mostrar la lista en el txtArea
private void mostrarListaEnTxtArea(Stack<String> pila) {
    // Limpiar el txtArea
    txtArea.setText("");

    // Mostrar la lista en el txtArea
    while (!pila.isEmpty()) {
        txtArea.append(pila.pop() + "\n");
    }
