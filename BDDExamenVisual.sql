CREATE DATABASE  IF NOT EXISTS `pruebasconexion` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `pruebasconexion`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: pruebasconexion
-- ------------------------------------------------------
...
INSERT INTO `persona` VALUES (1,'Kevin','Teran','1755709605','Kevin750','1234'),(2,'Kevin','Teran','1755709605','null','null');
...
CREATE TABLE `vehiculos` (
  ...
  CONSTRAINT `vehiculos_ibfk_1` FOREIGN KEY (`idpersona`) REFERENCES `persona` (`idpersona`)
...
INSERT INTO `vehiculos` VALUES (1,'ASD-123','ROJO','TOYOTA','CAMIONETA',1500,1),(2,'ASD-154','Verde','Kia','Camioneta',15000,1),(3,'ASD-123','Verde','Skoda','Jeep',1200,2),(4,'asd-158','Azul','Kia','Camioneta',1560,2),(5,'AXE-987','Amarillo','Skoda','Camioneta',15000,2),(6,'AZE-157','Azul','Skoda','Camioneta',15000,2),(7,'1235-45','Verde','Kia','Jeep',1022,2);
/*!40000 ALTER TABLE `vehiculos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'pruebasconexion'
--

--
-- Dumping routines for database 'pruebasconexion'
--
/*!50003 DROP PROCEDURE IF EXISTS `AgregarVehiculo` */;
...
/*!50003 DROP PROCEDURE IF EXISTS `ObtenerPropietario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    ...
    -- Buscar los nombres completos del propietario usando la cedula proporcionada
    SELECT CONCAT(nombres, ' ', apellidos) INTO nombres_propietario
    FROM persona
    WHERE cedula = cedula_propietario;

    -- Mostrar los nombres completos del propietario
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_CrearPersona` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `VehiculosPropietario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2024-02-14 17:55:22
