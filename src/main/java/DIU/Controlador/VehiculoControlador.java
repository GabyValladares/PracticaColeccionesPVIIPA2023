...
public class VehiculoControlador {
  private Vehiculo vehiculo;
    ...
    public void insertarVehiculo(Vehiculo v1, int cedulaPersona) {
        ...
        try {
           String sql = "CALL sp_InsertarVehiculo(?, ?, ?, ?, ?, ?)";
            ...
            preparedStatement.setString(1, v1.getPlaca());
            preparedStatement.setString(2, v1.getColor());
            preparedStatement.setString(3, v1.getMarca());
            preparedStatement.setString(4, v1.getTipo());
            preparedStatement.setDouble(5, v1.getValor());
            preparedStatement.setInt(6, cedulaPersona); // Cédula de la persona asociada al vehículo
