 ...
 * @author guami
 */
public class TablaFicha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPORTE FICHA VEHICULAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaFicha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaFicha().setVisible(true);
